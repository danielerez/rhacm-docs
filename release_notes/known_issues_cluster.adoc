...
For Cluster lifecycle with the {mce} known issues, see link:../clusters/release_notes/known_issues.adoc#known-issues-mce[Cluster lifecycle known issues and limitations] in the {mce-short} documentation.
