...
*Note:* The `hubKubeAPIServerURL` field is deprecated. See xref:../release_notes/mce_deprecate_remove.adoc#api-deprecations-cluster[API deprecations] to learn more.
