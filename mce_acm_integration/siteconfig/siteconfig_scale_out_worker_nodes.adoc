...
* You have installed your cluster with the {sco}. To install a cluster with the {sco}, see see xref:../siteconfig/install-clusters.adoc#install-clusters[Installing {sno} clusters with the {sco}]
