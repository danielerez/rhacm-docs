...
* You have the default cluster templates. To get familiar with the default templates, see xref:../siteconfig_cluster_templates.adoc#default-templates[Default set of templates]
