...
When you check the `ManagedClusterAddon` status, part of the configurations has an empty `spec` hash, even if the configurations exist. See the following example:
