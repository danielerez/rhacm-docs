...
....
GET /cluster.open-cluster-management.io/v1beta1/namespaces/{namespace}/klusterletconfigs
....
...
=== Query a single klusterletconfig
....
GET /klusterletconfigs.config.open-cluster-management.io/v1alpha1/klusterletconfigs/{klusterletconfig_name}
....
